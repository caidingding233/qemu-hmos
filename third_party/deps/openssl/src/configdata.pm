...
our %config = (
    "AR" => "/Users/caidingding233/Library/OpenHarmony/Sdk/18/native/llvm/bin/llvm-ar",
    "ARFLAGS" => [
        "qc"
    ],
    "ASFLAGS" => [],
    "CC" => "/Users/caidingding233/Library/OpenHarmony/Sdk/18/native/llvm/bin/aarch64-unknown-linux-ohos-clang",
    "CFLAGS" => [
        "--target=aarch64-unknown-linux-ohos --sysroot=/Users/caidingding233/Library/OpenHarmony/Sdk/18/native/sysroot -D__MUSL__ -fPIC"
    ],
    "CPPDEFINES" => [],
    "CPPFLAGS" => [],
    "CPPINCLUDES" => [],
    "CXX" => "/Users/caidingding233/Library/OpenHarmony/Sdk/18/native/llvm/bin/aarch64-unknown-linux-ohos-clang++",
    "CXXFLAGS" => [
        "-Wall -O3"
    ],
    ...
    "LDFLAGS" => [
        "--target=aarch64-unknown-linux-ohos --sysroot=/Users/caidingding233/Library/OpenHarmony/Sdk/18/native/sysroot"
    ],
    "LDLIBS" => [],
    "PERL" => "perl",
    "RANLIB" => "/Users/caidingding233/Library/OpenHarmony/Sdk/18/native/llvm/bin/llvm-ranlib",
    "RC" => "windres",
    "RCFLAGS" => [],
    "afalgeng" => "",
    "api" => "30300",
    ...
    "openssl_sys_defines" => [],
    "openssldir" => "/Users/caidingding233/projects/qemu-hmos/third_party/deps/install-ohos/ssl",
    "options" => "--prefix=/Users/caidingding233/projects/qemu-hmos/third_party/deps/install-ohos --openssldir=/Users/caidingding233/projects/qemu-hmos/third_party/deps/install-ohos/ssl --libdir=lib no-acvp-tests no-asan no-brotli no-brotli-dynamic no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-docs no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fips no-fips-securitychecks no-fuzz-afl no-fuzz-libfuzzer no-ktls no-loadereng no-md2 no-msan no-rc5 no-sctp no-shared no-ssl3 no-ssl3-method no-tests no-tfo no-trace no-ubsan no-unit-test no-uplink no-weak-ssl-ciphers no-winstore no-zlib no-zlib-dynamic no-zstd no-zstd-dynamic",
    "patch" => "1",
    ...
    "perlargv" => [
        ...
        "no-tests",
        "no-docs",
        "--prefix=/Users/caidingding233/projects/qemu-hmos/third_party/deps/install-ohos",
        "--openssldir=/Users/caidingding233/projects/qemu-hmos/third_party/deps/install-ohos/ssl",
        "--libdir=lib",
        "CFLAGS=--target=aarch64-unknown-linux-ohos --sysroot=/Users/caidingding233/Library/OpenHarmony/Sdk/18/native/sysroot -D__MUSL__ -fPIC",
        "LDFLAGS=--target=aarch64-unknown-linux-ohos --sysroot=/Users/caidingding233/Library/OpenHarmony/Sdk/18/native/sysroot"
    ],
    "perlenv" => {
        "AR" => "/Users/caidingding233/Library/OpenHarmony/Sdk/18/native/llvm/bin/llvm-ar",
        "ARFLAGS" => undef,
...
unless (caller) {
    ...
    use lib '/Users/caidingding233/projects/qemu-hmos/third_party/deps/openssl/src/util/perl';
    use OpenSSL::fallback '/Users/caidingding233/projects/qemu-hmos/third_party/deps/openssl/src/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/Users/caidingding233/projects/qemu-hmos/third_party/deps/openssl/src/Configurations';
        use gentemplate;
